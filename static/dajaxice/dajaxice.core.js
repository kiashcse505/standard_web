...
var Dajaxice = {
    ...
    updateDivision: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.geolocation.updateDivision', 'POST', callback_function, argv, custom_settings);
    },

    updateDistrict: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.geolocation.updateDistrict', 'POST', callback_function, argv, custom_settings);
    },

    changeCountry: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.geolocation.changeCountry', 'POST', callback_function, argv, custom_settings);
    },

    updateEthnicity: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.geolocation.updateEthnicity', 'POST', callback_function, argv, custom_settings);
    },

    updateRegion: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.geolocation.updateRegion', 'POST', callback_function, argv, custom_settings);
    }
